...
const translations = {
  it: {
    ...
    "transfer.multipleFiles": "Trascina più file o clicca ovunque per selezionarli.",
    ...
    "lang.current": "Attiva",
    "theme.choose": "Tema",
    "theme.current": "Attivo",
    "theme.light": "Chiaro",
    "theme.dark": "Scuro",
    "theme.system": "Sistema",
    "theme.lightDescription": "Interfaccia chiara",
    "theme.darkDescription": "Interfaccia scura",
    "theme.systemDescription": "Usa il tema del sistema",
  ...
  en: {
    ...
    "transfer.multipleFiles": "Drag multiple files or click anywhere to select them.",
    ...
    "theme.dark": "Dark",
    "theme.system": "System",
    "theme.lightDescription": "Light interface",
    "theme.darkDescription": "Dark interface",
    "theme.systemDescription": "Use system theme",
