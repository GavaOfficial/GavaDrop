...
import { Upload, Share2, Wifi, Smartphone, Monitor, Tablet, FileDown, FileUp, Edit3, Check, X, File, Trash2, Send } from "lucide-react";
...
export default function Home() {
  ...
  }, [selectedFiles, selectedPeer, sendFile, sendBatchFiles]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex">
      ...
      <div className="w-80 bg-background border-r border-border flex flex-col shadow-lg">
        {/* Sidebar Header */}
        <div className="p-6 border-b border-border bg-muted/30">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-white dark:bg-gray-900 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-200">
              <Image 
                src="/icon.png" 
                alt="GavaDrop Icon" 
                width={32} 
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-b border-gray-200/50 dark:border-gray-700/50 p-6 bg-gradient-to-r from-white to-blue-50/30 dark:from-gray-800 dark:to-blue-900/10">
          ...
          <p className="text-muted-foreground ml-5 font-medium">
            {selectedPeer 
        ...
        <div className="flex-1 p-6 flex flex-col gap-6">
          ...
          {/* Selected Files List */}
          {selectedFiles.length > 0 && (
            <div className="flex-1 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl border border-gray-200/50 dark:border-gray-700/50 p-6 shadow-xl shadow-blue-500/5">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    ...
                    disabled={!selectedPeer || selectedFiles.length === 0 || isSending}
                    size="sm"
